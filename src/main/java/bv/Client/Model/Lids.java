...
public class Lids {
     ...
     */
    public Lids(String cardImage, String value) {
     ...
     *
     * @param discArrayList a list of Lids objects
     * @return a list of the values of the Lids objects
     */
    public static ArrayList<String> convertToValue(ArrayList<Lids> discArrayList) {
        ArrayList<String> result = new ArrayList<>();
        for (Lids Lids : discArrayList) {
            if (!Lids.checkIsGuess()) {
                result.add(Lids.value);
            }
        }
        return result;
    }
